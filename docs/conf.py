...
htmlhelp_basename = 'invenio-csl-rest_namedoc'
...
latex_documents = [
  (master_doc, 'invenio-csl-rest.tex', u'invenio-csl-rest Documentation',
   u'CERN', 'manual'),
]
...
man_pages = [
    (master_doc, 'invenio-csl-rest', u'invenio-csl-rest Documentation',
     [author], 1)
]
...
texinfo_documents = [
  (master_doc, 'invenio-csl-rest', u'Invenio-CSL-REST Documentation',
   author, 'invenio-csl-rest', 'REST API for Citation Style Language styles.',
   'Miscellaneous'),
]
